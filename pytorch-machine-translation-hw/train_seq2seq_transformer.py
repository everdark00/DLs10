...
if __name__ == "__main__":
    ...
    data_config = yaml.load(open("C:/Users/peter/anaconda3/envs/cv/Scripts/pytorch-machine-translation-hw/configs/data_config.yaml", 'r'),   Loader=yaml.Loader)
    dm = DataManager(data_config, DEVICE)
    train_dataloader, dev_dataloader = dm.prepare_data()

    model_config = yaml.load(open("C:/Users/peter/anaconda3/envs/cv/Scripts/pytorch-machine-translation-hw/configs/model_config.yaml", 'r'),   Loader=yaml.Loader)
